 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sy={["no-app"]:"No Firebase App '{$appName}' has been created - call initializeApp() first",["bad-app-name"]:"Illegal App name: '{$appName}",["duplicate-app"]:"Firebase App named '{$appName}' already exists with different options or config",["app-deleted"]:"Firebase App named '{$appName}' already deleted",["no-options"]:"Need to provide options, when not being deployed to hosting via source.",["invalid-app-argument"]:"firebase.{$appName}() takes either no argument or a Firebase App instance.",["invalid-log-argument"]:"First argument to `onLog` must be null or a function.",["idb-open"]:"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.",["idb-get"]:"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.",["idb-set"]:"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.",["idb-delete"]:"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},Zt=new qr("app","Firebase",Sy);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const er=Ey;function Ru(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:ho,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw Zt.create("bad-app-name",{appName:String(s)});if(n||(n=Tu()),!n)throw Zt.create("no-options");const i=Ls.get(s);if(i){if(Ns(n,i.options)&&Ns(r,i.config))return i;throw Zt.create("duplicate-app",{appName:s})}const o=new Ng(s);for(const c of fo.values())o.addComponent(c);const l=new Ay(n,r,o);return Ls.set(s,l),l}function Ou(t=ho){const e=Ls.get(t);if(!e&&t===ho&&Tu())return Ru();if(!e)throw Zt.create("no-app",{appName:t});return e}function en(t,e,n){var r;let s=(r=Iy[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const l=[`Unable to register library "${s}" with version "${e}":`];i&&l.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),bn.warn(l.join(" "));return}Gn(new wn(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ly(t){Gn(new wn("platform-logger",e=>new Jg(e),"PRIVATE")),Gn(new wn("heartbeat",e=>new Dy(e),"PRIVATE")),en(uo,El,t),en(uo,El,"esm2017"),en("fire-js","")}Ly("");var $y="firebase",My="9.22.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new tn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Qe(this.firestore,e,this._key)}}class sn{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new sn(this.firestore,e,this._query)}}class tn extends sn{constructor(e,n,r){super(e,n,new fi(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Qe(this.firestore,null,new Fe(e))}withConverter(e){return new tn(this.firestore,e,this._path)}}function _e(t,e,...n){if(t=Ve(t),Vu("collection","path",e),t instanceof Yr){const r=Ne.fromString(e,...n);return Rl(r),new tn(t,null,r)}{if(!(t instanceof Qe||t instanceof tn))throw new Y(Z,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Ne.fromString(e,...n));return Rl(r),new tn(t.firestore,null,r)}}function Ae(t,e,...n){if(t=Ve(t),arguments.length===1&&(e=e_.N()),Vu("doc","path",e),t instanceof Yr){const r=Ne.fromString(e,...n);return Cl(r),new Qe(t,null,new Fe(r))}{if(!(t instanceof Qe||t instanceof tn))throw new Y(Z,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Ne.fromString(e,...n));return Cl(r),new Qe(t.firestore,t instanceof tn?t.converter:null,new Fe(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt extends es{constructor(){super("facebook.com")}static credential(e){return Cn._fromParams({providerId:Wt.PROVIDER_ID,signInMethod:Wt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Wt.credentialFromTaggedObject(e)}static credentialFromError(e){return Wt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Wt.credential(e.oauthAccessToken)}catch{return null}}}Wt.FACEBOOK_SIGN_IN_METHOD="facebook.com";Wt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt extends es{constructor(){super("google.com"),this.addScope("profile")}static credential(e,n){return Cn._fromParams({providerId:Kt.PROVIDER_ID,signInMethod:Kt.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:n})}static credentialFromResult(e){return Kt.credentialFromTaggedObject(e)}static credentialFromError(e){return Kt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:n,oauthAccessToken:r}=e;if(!n&&!r)return null;try{return Kt.credential(n,r)}catch{return null}}}Kt.GOOGLE_SIGN_IN_METHOD="google.com";Kt.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt extends es{constructor(){super("github.com")}static credential(e){return Cn._fromParams({providerId:Gt.PROVIDER_ID,signInMethod:Gt.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Gt.credentialFromTaggedObject(e)}static credentialFromError(e){return Gt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Gt.credential(e.oauthAccessToken)}catch{return null}}}Gt.GITHUB_SIGN_IN_METHOD="github.com";Gt.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jw=5*60,Qw=Su("authIdTokenMaxAge")||Jw;let lc=null;const Xw=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Qw)return;const s=n==null?void 0:n.token;lc!==s&&(lc=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function fs(t=Ou()){const e=qo(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Tv(t,{popupRedirectResolver:Ww,persistence:[rw,zv,Vd]}),r=Su("authTokenSyncURL");if(r){const i=Xw(r);Vv(n,i,()=>i(n.currentUser)),jv(n,o=>i(o))}const s=Iu("auth");return s&&Av(n,`http://${s}`),n}Yw("Browser");const Zw={apiKey:"AIzaSyDYHZD3qXhHcDa367tMXjHz7qzaZFYRA4c",authDomain:"gold-smith-jewelers.firebaseapp.com",projectId:"gold-smith-jewelers",storageBucket:"gold-smith-jewelers.appspot.com",messagingSenderId:"705110080489",appId:"1:705110080489:web:d8228e6b206399c5c5e978",measurementId:"G-M8LFGYRVKL"},eb=Ru(Zw),ge=x_(eb);class tb{constructor(){this.collectionName=De.INVOICES}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e.invoiceNumber));if(r.exists())throw"Invoice cannot be updated";an.fillUpdatedInfo(e),await Ft(Ae(n,e.invoiceNumber),e),await fb.addOrUpdate({receiptNumber:"PR"+e.invoiceNumber,invoiceRef:e.invoiceNumber,paymentDate:e.purchaseDate,amount:-1*e.totals.totalMakingCharge,customer:e.customer,customerId:e.customerId,description:"Auto added by purchase"+e.invoiceNumber}),await pb.addOrUpdate({receiptNumber:"GR"+e.invoiceNumber,invoiceRef:e.invoiceNumber,paymentDate:e.purchaseDate,weight:-1*e.totals.pureWeight,purity:1e3,customer:e.customer,customerId:e.customerId,description:"Auto added by purchase"+e.invoiceNumber}),on.log(e,"Invoice","Created"+e.invoiceNumber)}async list(e,n,r){const s=_e(ge,this.collectionName),i=Lt(s,Qr("purchaseDate","desc"),Ei(10)),l=(await Ct(i)).docs.map(h=>h.data());if(r){var c=r.toLowerCase().trim();return _.filter(l,function(h){return h.invoiceNumber.toLowerCase().includes(c)||h.customer.toLowerCase().includes(c)})}return l}async listByCustomer(e){if(!e)return[];const n=_e(ge,this.collectionName),r=Lt(n,bi("customerId","==",e));return(await Ct(r)).docs.map(o=>o.data())}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data()}}class nb{constructor(){this.collectionName=De.SETTINGS}async addOrUpdate(e){const n=_e(ge,this.collectionName);an.fillUpdatedInfo(e),await Ft(Ae(n,e.identifier),e),on.log(e,"Settings","Changed settings "+e.identifier)}async getById(e){const n=_e(ge,this.collectionName),r=await mt(Ae(n,e));return r.exists()?r.data():{identifier:e}}}class rb{constructor(){this.collectionName=De.USERS}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r="Updated";e.id||(e.id=e.Email,r="Added");const s=e.Password;e.Password=null,an.fillUpdatedInfo(e),await Ft(Ae(n,e.Email),e),on.log(e,"User",r+":"+JSON.stringify(e)),r=="Added"&&await Ai.createUser(e.Email,s)}async getById(e){if(!e)return;const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data()}async list(){const e=_e(ge,this.collectionName);return(await Ct(e)).docs.map(s=>s.data())}}class sb{constructor(){this.collectionName=De.USER_CUSTOMER_MAPPING}async list(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));return r.exists()?r.data().customers:[]}async addOrUpdate(e,n){const r=_e(ge,this.collectionName);return await Ft(Ae(r,e),{customers:n})}}class ib{constructor(){this.collectionName=De.RATES}async addOrUpdate(e){let n=Kn.getTodayAsString();const r=_e(ge,this.collectionName);var s={rate:e.rate,date:n};an.fillUpdatedInfo(s),await Ft(Ae(r,n),s),on.log(s,"Rate","Changed rate to "+s.rate)}async list(){const e=_e(ge,this.collectionName),n=Lt(e,Qr("date","desc"),Ei(10));return(await Ct(n)).docs.map(i=>i.data())}async getTodaysRate(){let e=Kn.getTodayAsString();const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data().rate}}class ob{constructor(){this.collectionName=De.CCUSTOMERS}async list(e,n=!1,r=!1){const s=_e(ge,this.collectionName);var i=null;n&&(i=bi("status","==","Active"));const o=Lt(s,i);var c=(await Ct(o)).docs.map(h=>h.data());if(!r){console.log("Called");const h=await mb.list(Ai.getCurrentUser().email);c=_.filter(c,function(m){return h.includes(m.id)})}if(e){const h=e.toLowerCase();c=_.filter(c,function(m){return m.Name.toLowerCase().includes(h)||m.Contact&&m.Contact.toString().toLowerCase().includes(h)})}return c=_.sortBy(c,function(h){return h.Name}),c}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r="Updated";e.id||(e.id=Ae(n).id,r="Added"),an.fillUpdatedInfo(e),await Ft(Ae(n,e.id),e),on.log(e,"Customer",r+":"+JSON.stringify(e))}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data()}async runDebitCreditTransaction(e,n,r){const s=Ae(_e(ge,this.collectionName),e);try{await G_(ge,async i=>{const o=await i.get(s);if(!o.exists())throw"Document does not exist!";const l=r+"Debit",c=r+"Credit",h=o.data();n<0?h[l]?h[l]+=n*-1:h[l]=n*-1:h[c]?h[c]+=n:h[c]=n,i.update(s,h)}),console.log("Transaction successfully committed!")}catch(i){console.log("Transaction failed: ",i)}}}class ab{constructor(){this.collectionName=De.PRODUCTS}async list(e){const n=_e(ge,this.collectionName),r=Lt(n,Qr("Name"));var i=(await Ct(r)).docs.map(o=>o.data());if(e){const o=e.toLowerCase();i=_.filter(i,function(l){return l.Name.toLowerCase().includes(o)})}return i}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r="Updated";e.id||(e.id=Ae(n).id,r="Added"),an.fillUpdatedInfo(e),await Ft(Ae(n,e.id),e),on.log(e,"Product",r+":"+JSON.stringify(e))}}class lb{constructor(){this.collectionName=De.CASH_PAYMENTS}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e.receiptNumber));if(r.exists())throw"Cash payment cannot be updated";an.fillUpdatedInfo(e),await Ft(Ae(n,e.receiptNumber),e),await Gd.runDebitCreditTransaction(e.customerId,e.amount,"Cash"),on.log(e,"CashPayment","Added :"+e.receiptNumber)}async list(e,n){const r=_e(ge,this.collectionName),s=Lt(r,Qr("paymentDate","desc"),Ei(10));return(await Ct(s)).docs.map(l=>l.data())}async listByCustomer(e){if(!e)return[];const n=_e(ge,this.collectionName),r=Lt(n,bi("customerId","==",e));return(await Ct(r)).docs.map(o=>o.data())}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data()}}class cb{constructor(){this.collectionName=De.GOLD_PAYMENTS}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e.receiptNumber));if(r.exists())throw"Gold Payment cannot be updated";an.fillUpdatedInfo(e),await Ft(Ae(n,e.receiptNumber),e),await Gd.runDebitCreditTransaction(e.customerId,e.weight*(e.purity/1e3),"Gold"),on.log(e,"GoldPayment","Added :"+e.receiptNumber)}async list(e,n){const r=_e(ge,this.collectionName),s=Lt(r,Qr("paymentDate","desc"),Ei(10));return(await Ct(s)).docs.map(l=>l.data())}async listByCustomer(e){if(!e)return[];const n=_e(ge,this.collectionName),r=Lt(n,bi("customerId","==",e));return(await Ct(r)).docs.map(o=>o.data())}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data()}}class ub{async tryLogin(e,n){const r=fs();return await Fv(r,e,n)}getCurrentUser(){return fs().currentUser}async createUser(e,n){return await Uv(fs(),e,n)}async signOut(){this.getCurrentUser()&&await fs().signOut()}}class db{constructor(){this.collectionName=De.AUDIT}async log(e,n,r){_e(ge,this.collectionName)}}class hb{fillUpdatedInfo(e){const n=Ai.getCurrentUser();e.updatedByDisplayName=n.displayName??n.email,e.updatedBy=n.uid,e.updatedOn=Kn.getNowAsMilliSeconds()}}const Sb=new tb,Ab=new rb,Cb=new ib,Gd=new ob,Rb=new ab,Ob=new nb,fb=new lb,pb=new cb,Ai=new ub,on=new db,an=new hb,mb=new sb,jt=Ip(Cm);jt.use(vu);jt.mount("#app");jt.config.globalProperties.$currentuser={};jt.config.globalProperties.$appname="Emirates Pearl Jewellery";jt.config.globalProperties.$appShortName="Emirates Pearl";jt.config.globalProperties.$basedomainname="/goldsmithjk/";jt.config.globalProperties.$statusLabelMapper={enabled:"Active",disabled:"Inactive"};jt.config.globalProperties.$alertShowDuration=3e3;jt.config.globalProperties.$adminMailId="admin@goldsmith.com";vu.beforeEach((t,e,n)=>{if(t.path.startsWith("/payments/")||t.path.startsWith("/invoices/")||t.path.startsWith("/login")||t.path.startsWith("/goldtransaction/")){n();return}Ai.getCurrentUser()?n():n({path:"/login",query:{nextUrl:t.path}})});export{zl as A,Eo as B,Kn as C,qi as D,Ab as E,ot as F,vb as G,Tb as I,Bi as S,Pm as _,wb as a,le as b,Bf as c,wf as d,Ib as e,be as f,bb as g,ai as h,Ge as i,ng as j,Cb as k,Sb as l,it as m,Gd as n,Br as o,Rb as p,If as q,_b as r,Ob as s,uc as t,yn as u,Eb as v,yb as w,Ai as x,fb as y,pb as z};
