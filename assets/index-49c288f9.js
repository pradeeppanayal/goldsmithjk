 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ym="FirebaseError";class Ut extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=Ym,Object.setPrototypeOf(this,Ut.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Kr.prototype.create)}}class Kr{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?Jm(i,r):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Ut(s,a,r)}}function Jm(t,e){return t.replace(Qm,(n,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Qm=/\{\$([^}]+)}/g;function Xm(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function Us(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const s of n){if(!r.includes(s))return!1;const i=t[s],o=e[s];if(El(i)&&El(o)){if(!Us(i,o))return!1}else if(i!==o)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function El(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jg={["no-app"]:"No Firebase App '{$appName}' has been created - call initializeApp() first",["bad-app-name"]:"Illegal App name: '{$appName}",["duplicate-app"]:"Firebase App named '{$appName}' already exists with different options or config",["app-deleted"]:"Firebase App named '{$appName}' already deleted",["no-options"]:"Need to provide options, when not being deployed to hosting via source.",["invalid-app-argument"]:"firebase.{$appName}() takes either no argument or a Firebase App instance.",["invalid-log-argument"]:"First argument to `onLog` must be null or a function.",["idb-open"]:"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.",["idb-get"]:"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.",["idb-set"]:"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.",["idb-delete"]:"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},en=new Kr("app","Firebase",Jg);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr=Kg;function Du(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:fo,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw en.create("bad-app-name",{appName:String(s)});if(n||(n=Ru()),!n)throw en.create("no-options");const i=Fs.get(s);if(i){if(Us(n,i.options)&&Us(r,i.config))return i;throw en.create("duplicate-app",{appName:s})}const o=new ig(s);for(const c of po.values())o.addComponent(c);const a=new Qg(n,r,o);return Fs.set(s,a),a}function xu(t=fo){const e=Fs.get(t);if(!e&&t===fo&&Ru())return Du();if(!e)throw en.create("no-app",{appName:t});return e}function tn(t,e,n){var r;let s=(r=Gg[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${s}" with version "${e}":`];i&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),En.warn(a.join(" "));return}Jn(new bn(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xg="firebase-heartbeat-database",Zg=1,Lr="firebase-heartbeat-store";let ji=null;function Nu(){return ji||(ji=_g(Xg,Zg,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Lr)}}}).catch(t=>{throw en.create("idb-open",{originalErrorMessage:t.message})})),ji}async function ey(t){try{return await(await Nu()).transaction(Lr).objectStore(Lr).get(Lu(t))}catch(e){if(e instanceof Ut)En.warn(e.message);else{const n=en.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});En.warn(n.message)}}}async function Cl(t,e){try{const r=(await Nu()).transaction(Lr,"readwrite");await r.objectStore(Lr).put(e,Lu(t)),await r.done}catch(n){if(n instanceof Ut)En.warn(n.message);else{const r=en.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});En.warn(r.message)}}}function Lu(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oy(t){Jn(new bn("platform-logger",e=>new bg(e),"PRIVATE")),Jn(new bn("heartbeat",e=>new ry(e),"PRIVATE")),tn(ho,Al,t),tn(ho,Al,"esm2017"),tn("fire-js","")}oy("");var ay="firebase",ly="9.22.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qn=new qo("@firebase/firestore");function In(t,...e){if(Qn.logLevel<=me.DEBUG){const n=e.map(Wo);Qn.debug(`Firestore (${sr}): ${t}`,...n)}}function fi(t,...e){if(Qn.logLevel<=me.ERROR){const n=e.map(Wo);Qn.error(`Firestore (${sr}): ${t}`,...n)}}function $u(t,...e){if(Qn.logLevel<=me.WARN){const n=e.map(Wo);Qn.warn(`Firestore (${sr}): ${t}`,...n)}}function Wo(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function be(t="Unexpected state"){const e=`FIRESTORE (${sr}) INTERNAL ASSERTION FAILED: `+t;throw fi(e),new Error(e)}function st(t,e){t||be()}function Yr(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _y{constructor(e,n,r,s,i,o,a,c,h){this.databaseId=e,this.appId=n,this.persistenceKey=r,this.host=s,this.ssl=i,this.forceLongPolling=o,this.autoDetectLongPolling=a,this.longPollingOptions=c,this.useFetchStreams=h}}class $r{constructor(e,n){this.projectId=e,this.database=n||"(default)"}static empty(){return new $r("","")}get isDefaultDatabase(){return this.database==="(default)"}isEqual(e){return e instanceof $r&&e.projectId===this.projectId&&e.database===this.database}}class Mr{constructor(e,n,r){n===void 0?n=0:n>e.length&&be(),r===void 0?r=e.length-n:r>e.length-n&&be(),this.segments=e,this.offset=n,this.len=r}get length(){return this.len}isEqual(e){return Mr.comparator(this,e)===0}child(e){const n=this.segments.slice(this.offset,this.limit());return e instanceof Mr?e.forEach(r=>{n.push(r)}):n.push(e),this.construct(n)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let n=0;n<this.length;n++)if(this.get(n)!==e.get(n))return!1;return!0}forEach(e){for(let n=this.offset,r=this.limit();n<r;n++)e(this.segments[n])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,n){const r=Math.min(e.length,n.length);for(let s=0;s<r;s++){const i=e.get(s),o=n.get(s);if(i<o)return-1;if(i>o)return 1}return e.length<n.length?-1:e.length>n.length?1:0}}class Le extends Mr{construct(e,n,r){return new Le(e,n,r)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}static fromString(...e){const n=[];for(const r of e){if(r.indexOf("//")>=0)throw new Y(Z,`Invalid segment (${r}). Paths must not contain // in them.`);n.push(...r.split("/").filter(s=>s.length>0))}return new Le(n)}static emptyPath(){return new Le([])}}const vy=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class nt extends Mr{construct(e,n,r){return new nt(e,n,r)}static isValidIdentifier(e){return vy.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),nt.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)==="__name__"}static keyField(){return new nt(["__name__"])}static fromServerFormat(e){const n=[];let r="",s=0;const i=()=>{if(r.length===0)throw new Y(Z,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);n.push(r),r=""};let o=!1;for(;s<e.length;){const a=e[s];if(a==="\\"){if(s+1===e.length)throw new Y(Z,"Path has trailing escape character: "+e);const c=e[s+1];if(c!=="\\"&&c!=="."&&c!=="`")throw new Y(Z,"Path has invalid escape sequence: "+e);r+=c,s+=2}else a==="`"?(o=!o,s++):a!=="."||o?(r+=a,s++):(i(),s++)}if(i(),o)throw new Y(Z,"Unterminated ` in path: "+e);return new nt(n)}static emptyPath(){return new nt([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(ue=xl||(xl={}))[ue.OK=0]="OK",ue[ue.CANCELLED=1]="CANCELLED",ue[ue.UNKNOWN=2]="UNKNOWN",ue[ue.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",ue[ue.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",ue[ue.NOT_FOUND=5]="NOT_FOUND",ue[ue.ALREADY_EXISTS=6]="ALREADY_EXISTS",ue[ue.PERMISSION_DENIED=7]="PERMISSION_DENIED",ue[ue.UNAUTHENTICATED=16]="UNAUTHENTICATED",ue[ue.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",ue[ue.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",ue[ue.ABORTED=10]="ABORTED",ue[ue.OUT_OF_RANGE=11]="OUT_OF_RANGE",ue[ue.UNIMPLEMENTED=12]="UNIMPLEMENTED",ue[ue.INTERNAL=13]="INTERNAL",ue[ue.UNAVAILABLE=14]="UNAVAILABLE",ue[ue.DATA_LOSS=15]="DATA_LOSS";class Iy extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const n=e.ssl?"https":"http";this.m=n+"://"+e.host,this.p="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get g(){return!1}v(e,n,r,s,i){const o=by(),a=this.I(e,n);In("RestConnection",`Sending RPC '${e}' ${o}:`,a,r);const c={};return this.T(c,s,i),this.A(e,a,c,r).then(h=>(In("RestConnection",`Received RPC '${e}' ${o}: `,h),h),h=>{throw $u("RestConnection",`RPC '${e}' ${o} failed with error: `,h,"url: ",a,"request:",r),h})}R(e,n,r,s,i,o){return this.v(e,n,r,s,i)}T(e,n,r){e["X-Goog-Api-Client"]="gl-js/ fire/"+sr,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach((s,i)=>e[i]=s),r&&r.headers.forEach((s,i)=>e[i]=s)}I(e,n){const r=Ey[e];return`${this.m}/v1/${n}:${r}`}}{constructor(e,n){super(e),this.P=n}V(e,n){throw new Error("Not supported by FetchConnection")}async A(e,n,r,s){var i;const o=JSON.stringify(s);let a;try{a=await this.P(n,{method:"POST",headers:r,body:o})}catch(c){const h=c;throw new Y(Nl(h.status),"Request failed with error: "+h.statusText)}if(!a.ok){let c=await a.json();Array.isArray(c)&&(c=c[0]);const h=(i=c==null?void 0:c.error)===null||i===void 0?void 0:i.message;throw new Y(Nl(a.status),`Request failed with error: ${h??a.statusText}`)}return a.json()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ll(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function Qr(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(r){try{return atob(r)}catch(s){throw typeof DOMException<"u"&&s instanceof DOMException?new Ay("Invalid base64 string: "+s):s}}(e);return new Nt(n)}static fromUint8Array(e){const n=function(r){let s="";for(let i=0;i<r.length;++i)s+=String.fromCharCode(r[i]);return s}(e);return new Nt(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return e=this.binaryString,btoa(e);var e}toUint8Array(){return function(e){const n=new Uint8Array(e.length);for(let r=0;r<e.length;r++)n[r]=e.charCodeAt(r);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Ue(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Nt.EMPTY_BYTE_STRING=new Nt("");const Cy=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Sn(t){if(st(!!t),typeof t=="string"){let e=0;const n=Cy.exec(t);if(st(!!n),n[1]){let s=n[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Ne(t.seconds),nanos:Ne(t.nanos)}}function Ne(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function Ur(t){return typeof t=="string"?Nt.fromBase64String(t):Nt.fromUint8Array(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yu(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function Ju(t){const e=t.mapValue.fields.__previous_value__;return Yu(e)?Ju(e):e}function Fr(t){const e=Sn(t.mapValue.fields.__local_write_time__.timestampValue);return new it(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Er{constructor(e,n="asc"){this.field=e,this.dir=n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n_ extends class{}{constructor(e,n,r,s){super(),this.authCredentials=e,this.appCheckCredentials=n,this.connection=r,this.serializer=s,this.J=!1}X(){if(this.J)throw new Y(Tn,"The client has already been terminated.")}v(e,n,r){return this.X(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([s,i])=>this.connection.v(e,n,r,s,i)).catch(s=>{throw s.name==="FirebaseError"?(s.code===Vs&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),s):new Y(Vn,s.toString())})}R(e,n,r,s){return this.X(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,o])=>this.connection.R(e,n,r,i,o,s)).catch(i=>{throw i.name==="FirebaseError"?(i.code===Vs&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new Y(Vn,i.toString())})}terminate(){this.J=!0}}async function ad(t,e){const n=Yr(t),r=rd(n.serializer)+"/documents",s={writes:e.map(i=>Jy(n.serializer,i))};await n.v("Commit",r,s)}async function ld(t,e){const n=Yr(t),r=rd(n.serializer)+"/documents",s={documents:e.map(c=>Ws(n.serializer,c))},i=await n.R("BatchGetDocuments",r,s,e.length),o=new Map;i.forEach(c=>{const h=Yy(n.serializer,c);o.set(h.key.toString(),h)});const a=[];return e.forEach(c=>{const h=o.get(c.toString());st(!!h),a.push(h)}),a}async function r_(t,e){const n=Yr(t),r=Qy(n.serializer,My(e));return(await n.R("RunQuery",r.parent,{structuredQuery:r.structuredQuery})).filter(s=>!!s.document).map(s=>function(i,o,a){const c=yo(i,o.name),h=Ir(o.updateTime),m=o.createTime?Ir(o.createTime):ke.min(),b=new rt({mapValue:{fields:o.fields}}),A=bt.newFoundDocument(c,h,m,b);return a&&A.setHasCommittedMutations(),a?A.setHasCommittedMutations():A}(n.serializer,s.document,void 0))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tr=new Map;function vi(t){if(t._terminated)throw new Y(Tn,"The client has already been terminated.");if(!Tr.has(t)){In("ComponentProvider","Initializing Datastore");const i=function(c){return new Iy(c,fetch.bind(null))}((e=t._databaseId,n=t.app.options.appId||"",r=t._persistenceKey,s=t._freezeSettings(),new _y(e,n,r,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,Wu(s.experimentalLongPollingOptions),s.useFetchStreams))),o=ea(t._databaseId),a=function(c,h,m,b){return new n_(c,h,m,b)}(t._authCredentials,t._appCheckCredentials,i,o);Tr.set(t,a)}var e,n,r,s;/**
* @license
* Copyright 2018 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new nn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Qe(this.firestore,e,this._key)}}class on{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new on(this.firestore,e,this._query)}}class nn extends on{constructor(e,n,r){super(e,n,new mi(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Qe(this.firestore,null,new Fe(e))}withConverter(e){return new nn(this.firestore,e,this._path)}}function _e(t,e,...n){if(t=je(t),zu("collection","path",e),t instanceof Zr){const r=Le.fromString(e,...n);return Dl(r),new nn(t,null,r)}{if(!(t instanceof Qe||t instanceof nn))throw new Y(Z,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Le.fromString(e,...n));return Dl(r),new nn(t.firestore,null,r)}}function Ae(t,e,...n){if(t=je(t),arguments.length===1&&(e=Sy.N()),zu("doc","path",e),t instanceof Zr){const r=Le.fromString(e,...n);return kl(r),new Qe(t,null,new Fe(r))}{if(!(t instanceof Qe||t instanceof nn))throw new Y(Z,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Le.fromString(e,...n));return kl(r),new Qe(t.firestore,t instanceof nn?t.converter:null,new Fe(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Xn(Nt.fromBase64String(e))}catch(n){throw new Y(Z,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new Xn(Nt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _d(t,e,n){let r;return r=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,r}class fa extends class{convertValue(e,n="none"){switch(An(e)){case 0:return null;case 1:return e.booleanValue;case 2:return Ne(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,n);case 5:return e.stringValue;case 6:return this.convertBytes(Ur(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,n);case 10:return this.convertObject(e.mapValue,n);default:throw be()}}convertObject(e,n){return this.convertObjectMap(e.fields,n)}convertObjectMap(e,n="none"){const r={};return Qr(e,(s,i)=>{r[s]=this.convertValue(i,n)}),r}convertGeoPoint(e){return new na(Ne(e.latitude),Ne(e.longitude))}convertArray(e,n){return(e.values||[]).map(r=>this.convertValue(r,n))}convertServerTimestamp(e,n){switch(n){case"previous":const r=Ju(e);return r==null?null:this.convertValue(r,n);case"estimate":return this.convertTimestamp(Fr(e));default:return null}}convertTimestamp(e){const n=Sn(e);return new it(n.seconds,n.nanos)}convertDocumentKey(e,n){const r=Le.fromString(e);st(id(r));const s=new $r(r.get(1),r.get(3)),i=new Fe(r.popFirst(5));return s.isEqual(n)||fi(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${n.projectId}/${n.database}) instead.`),i}}{constructor(e){super(),this.firestore=e}convertBytes(e){return new Xn(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Qe(this.firestore,null,n)}}function mt(t){const e=vi((t=Jr(t,Qe)).firestore),n=new fa(t.firestore);return ld(e,[t._key]).then(r=>{st(r.length===1);const s=r[0];return new Gs(t.firestore,n,t._key,s.isFoundDocument()?s:null,t.converter)})}function Ct(t){(function(r){if(r.limitType==="L"&&r.explicitOrderBy.length===0)throw new Y(Yo,"limitToLast() queries require specifying at least one orderBy() clause")})((t=Jr(t,on))._query);const e=vi(t.firestore),n=new fa(t.firestore);return r_(e,t._query).then(r=>{const s=r.map(i=>new md(t.firestore,n,i.key,i,t.converter));return t._query.limitType==="L"&&s.reverse(),new f_(t,s)})}function Ft(t,e,n){const r=_d((t=Jr(t,Qe)).converter,e,n),s=dd(sa(t.firestore),"setDoc",t._key,r,t.converter!==null,n);return ad(vi(t.firestore),[s.toMutation(t._key,It.none())])}function gs(t,e){if((t=je(t)).firestore!==e)throw new Y(Z,"Provided document reference is from a different Firestore instance.");return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ys=new qo("@firebase/auth");function b_(t,...e){Ys.logLevel<=me.WARN&&Ys.warn(`Auth (${rr}): ${t}`,...e)}function As(t,...e){Ys.logLevel<=me.ERROR&&Ys.error(`Auth (${rr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gt(t,...e){throw ga(t,...e)}function Tt(t,...e){return ga(t,...e)}function E_(t,e,n){const r=Object.assign(Object.assign({},w_()),{[e]:n});return new Kr("auth","Firebase",r).create(e,{appName:t.name})}function ga(t,...e){if(typeof t!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=t.name),t._errorFactory.create(n,...r)}return wd.create(t,...e)}function re(t,e,...n){if(!t)throw ga(e,...n)}function Pt(t){const e="INTERNAL ASSERTION FAILED: "+t;throw As(e),new Error(e)}function $t(t,e){t||Pt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ns{constructor(e,n){this.shortDelay=e,this.longDelay=n,$t(n>e,"Short delay should be less than long delay!"),this.isMobile=qm()||zm()}get(){return T_()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ya(t,e){$t(t.emulator,"Emulator should always be set here");const{url:n}=t.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function O_(t,e){return or(t,"POST","/v1/accounts:delete",e)}async function P_(t,e){return or(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jr(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof Ut&&x_(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function x_({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function U_(t,e){const n=await Ed(t,{},async()=>{const r=Gr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=t.config,o=Id(t,s,"/v1/token",`key=${i}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",bd.fetch()(o,{method:"POST",headers:a,body:r})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Br{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){re(e.idToken,"internal-error"),re(typeof e.idToken<"u","internal-error"),re(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):D_(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}async getToken(e,n=!1){return re(!this.accessToken||this.refreshToken,e,"user-token-expired"),!n&&this.accessToken&&!this.isExpired?this.accessToken:this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:r,refreshToken:s,expiresIn:i}=await U_(e,n);this.updateTokensAndExpiration(r,s,Number(i))}updateTokensAndExpiration(e,n,r){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,n){const{refreshToken:r,accessToken:s,expirationTime:i}=n,o=new Br;return r&&(re(typeof r=="string","internal-error",{appName:e}),o.refreshToken=r),s&&(re(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),i&&(re(typeof i=="number","internal-error",{appName:e}),o.expirationTime=i),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Br,this.toJSON())}_performRefresh(){return Pt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ql=new Map;function kt(t){$t(t instanceof Function,"Expected a class definition");let e=Ql.get(t);return e?($t(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,Ql.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xd(t,e=[]){let n;switch(t){case"Browser":n=Zl(ze());break;case"Worker":n=`${Zl(ze())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${rr}/${r}`}async function Nd(t,e){return or(t,"GET","/v2/recaptchaConfig",ir(t,e))}function ec(t){return t!==void 0&&t.enterprise!==void 0}class Ld{constructor(e){if(this.siteKey="",this.emailPasswordEnabled=!1,e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.emailPasswordEnabled=e.recaptchaEnforcementState.some(n=>n.provider==="EMAIL_PASSWORD_PROVIDER"&&n.enforcementState!=="OFF")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Y_(t,e){const n=zo(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(Us(i,e??{}))return s;gt(s,"already-initialized")}return n.initialize({options:e})}function J_(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(kt);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Q_(t,e,n){const r=ar(t);re(r._canInitEmulator,r,"emulator-config-failed"),re(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!!(n!=null&&n.disableWarnings),i=Ud(e),{host:o,port:a}=X_(e),c=a===null?"":`:${a}`;r.config.emulator={url:`${i}//${o}${c}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:a,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),s||Z_()}function Ud(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function X_(t){const e=Ud(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:nc(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:nc(o)}}}function nc(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function Z_(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wi(t,e){return rs(t,"POST","/v1/accounts:signInWithPassword",ir(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tv(t,e){return rs(t,"POST","/v1/accounts:signInWithEmailLink",ir(t,e))}async function nv(t,e){return rs(t,"POST","/v1/accounts:signInWithEmailLink",ir(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bn(t,e){return rs(t,"POST","/v1/accounts:signInWithIdp",ir(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ss extends Fd{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt extends ss{constructor(){super("facebook.com")}static credential(e){return Rn._fromParams({providerId:Kt.PROVIDER_ID,signInMethod:Kt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Kt.credentialFromTaggedObject(e)}static credentialFromError(e){return Kt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Kt.credential(e.oauthAccessToken)}catch{return null}}}Kt.FACEBOOK_SIGN_IN_METHOD="facebook.com";Kt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yt extends ss{constructor(){super("github.com")}static credential(e){return Rn._fromParams({providerId:Yt.PROVIDER_ID,signInMethod:Yt.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Yt.credentialFromTaggedObject(e)}static credentialFromError(e){return Yt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Yt.credential(e.oauthAccessToken)}catch{return null}}}Yt.GITHUB_SIGN_IN_METHOD="github.com";Yt.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ki(t,e){return rs(t,"POST","/v1/accounts:signUp",ir(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xs extends Ut{constructor(e,n,r,s){var i;super(n.code,n.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,Xs.prototype),this.customData={appName:e.name,tenantId:(i=e.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:n.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,n,r,s){return new Xs(e,n,r,s)}}function Vd(t,e,n,r){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?Xs._fromErrorAndOperation(t,i,e,r):i})}async function ov(t,e,n=!1){const r=await jr(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return On._forOperation(t,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function av(t,e,n=!1){const{auth:r}=t,s="reauthenticate";try{const i=await jr(t,Vd(r,s,e,t),n);re(i.idToken,r,"internal-error");const o=_a(i.idToken);re(o,r,"internal-error");const{sub:a}=o;return re(t.uid===a,r,"user-mismatch"),On._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&gt(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jd(t,e,n=!1){const r="signIn",s=await Vd(t,r,e),i=await On._fromIdTokenResponse(t,r,s);return n||await t._updateCurrentUser(i.user),i}async function lv(t,e){return jd(ar(t),e)}async function cv(t,e,n){var r;const s=ar(t),i={returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"};let o;if(!((r=s._getRecaptchaConfig())===null||r===void 0)&&r.emailPasswordEnabled){const h=await Qs(s,i,"signUpPassword");o=Ki(s,h)}else o=Ki(s,i).catch(async h=>{if(h.code==="auth/missing-recaptcha-token"){console.log("Sign-up is protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the sign-up flow.");const m=await Qs(s,i,"signUpPassword");return Ki(s,m)}else return Promise.reject(h)});const a=await o.catch(h=>Promise.reject(h)),c=await On._fromIdTokenResponse(s,"signIn",a);return await s._updateCurrentUser(c.user),c}function uv(t,e,n){return lv(je(t),lr.credential(e,n))}function dv(t,e,n,r){return je(t).onIdTokenChanged(e,n,r)}function hv(t,e,n){return je(t).beforeAuthStateChanged(e,n)}const Zs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jd{constructor(e,n,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:s,tenantId:i,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(h){this.reject(h)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Pv;case"linkViaPopup":case"linkViaRedirect":return Dv;case"reauthViaPopup":case"reauthViaRedirect":return kv;default:gt(this.auth,"internal-error")}}resolve(e){$t(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){$t(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hv(t,e={}){return or(t,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xv=new ns(5e3,15e3),Zv="__/auth/iframe",ew="emulator/auth/iframe",tw={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},nw=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function rw(t){const e=t.config;re(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?ya(e,ew):`https://${t.config.authDomain}/${Zv}`,r={apiKey:e.apiKey,appName:t.name,v:rr},s=nw.get(t.config.apiHost);s&&(r.eid=s);const i=t._getFrameworks();return i.length&&(r.fw=i.join(",")),`${n}?${Gr(r).slice(1)}`}async function sw(t){const e=await Qv(t),n=St().gapi;return re(n,t,"internal-error"),e.open({where:document.body,url:rw(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:tw,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const o=Tt(t,"network-request-failed"),a=St().setTimeout(()=>{i(o)},Xv.get());function c(){St().clearTimeout(a),s(r)}r.ping(c).then(c,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hw="__/auth/handler",fw="emulator/auth/handler",pw=encodeURIComponent("fac");async function cc(t,e,n,r,s,i){re(t.config.authDomain,t,"auth-domain-config-required"),re(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:rr,eventId:s};if(e instanceof Fd){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",Xm(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[m,b]of Object.entries(i||{}))o[m]=b}if(e instanceof ss){const m=e.getScopes().filter(b=>b!=="");m.length>0&&(o.scopes=m.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const m of Object.keys(a))a[m]===void 0&&delete a[m];const c=await t._getAppCheckToken(),h=c?`#${pw}=${encodeURIComponent(c)}`:"";return`${mw(t)}?${Gr(a).slice(1)}${h}`}function mw({config:t}){return t.emulator?ya(t,fw):`https://${t.authDomain}/${hw}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gi="webStorageSupport";class gw{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=zd,this._completeRedirectFn=Vv,this._overrideRedirectResult=Mv}async _openPopup(e,n,r,s){var i;$t((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const o=await cc(e,n,r,vo(),s);return uw(e,o,Ea())}async _openRedirect(e,n,r,s){await this._originValidation(e);const i=await cc(e,n,r,vo(),s);return vv(i),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:s,promise:i}=this.eventManagers[n];return s?Promise.resolve(s):($t(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await sw(e),r=new Bv(e);return n.register("authEvent",s=>(re(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(Gi,{type:Gi},s=>{var i;const o=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[Gi];o!==void 0&&n(!!o),gt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=Kv(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return Dd()||va()||Si()}}const yw=gw;var uc="@firebase/auth",dc="0.23.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bw=5*60,Ew=Ou("authIdTokenMaxAge")||bw;let hc=null;const Iw=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Ew)return;const s=n==null?void 0:n.token;hc!==s&&(hc=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function vs(t=xu()){const e=zo(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Y_(t,{popupRedirectResolver:yw,persistence:[Rv,gv,zd]}),r=Ou("authTokenSyncURL");if(r){const i=Iw(r);hv(n,i,()=>i(n.currentUser)),dv(n,o=>i(o))}const s=Cu("auth");return s&&Q_(n,`http://${s}`),n}ww("Browser");const Tw={apiKey:"AIzaSyDYHZD3qXhHcDa367tMXjHz7qzaZFYRA4c",authDomain:"gold-smith-jewelers.firebaseapp.com",projectId:"gold-smith-jewelers",storageBucket:"gold-smith-jewelers.appspot.com",messagingSenderId:"705110080489",appId:"1:705110080489:web:d8228e6b206399c5c5e978",measurementId:"G-M8LFGYRVKL"},Sw=Du(Tw),ge=s_(Sw);class Aw{constructor(){this.collectionName=De.INVOICES}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e.invoiceNumber));if(r.exists())throw"Invoice cannot be updated";ln.fillUpdatedInfo(e),await Ft(Ae(n,e.invoiceNumber),e),await Uw.addOrUpdate({receiptNumber:"PR"+e.invoiceNumber,invoiceRef:e.invoiceNumber,paymentDate:e.purchaseDate,amount:-1*e.totals.totalMakingCharge,customer:e.customer,customerId:e.customerId,description:"Auto added by purchase"+e.invoiceNumber}),await Fw.addOrUpdate({receiptNumber:"GR"+e.invoiceNumber,invoiceRef:e.invoiceNumber,paymentDate:e.purchaseDate,weight:-1*e.totals.pureWeight,purity:1e3,customer:e.customer,customerId:e.customerId,description:"Auto added by purchase"+e.invoiceNumber}),an.log(e,"Invoice","Created"+e.invoiceNumber)}async list(e,n,r){const s=_e(ge,this.collectionName),i=Lt(s,ts("purchaseDate","desc"),Ti(10)),a=(await Ct(i)).docs.map(h=>h.data());if(r){var c=r.toLowerCase().trim();return _.filter(a,function(h){return h.invoiceNumber.toLowerCase().includes(c)||h.customer.toLowerCase().includes(c)})}return a}async listByCustomer(e){if(!e)return[];const n=_e(ge,this.collectionName),r=Lt(n,Ii("customerId","==",e));return(await Ct(r)).docs.map(o=>o.data())}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data()}}class Cw{constructor(){this.collectionName=De.SETTINGS}async addOrUpdate(e){const n=_e(ge,this.collectionName);ln.fillUpdatedInfo(e),await Ft(Ae(n,e.identifier),e),an.log(e,"Settings","Changed settings "+e.identifier)}async getById(e){const n=_e(ge,this.collectionName),r=await mt(Ae(n,e));return r.exists()?r.data():{identifier:e}}}class Rw{constructor(){this.collectionName=De.USERS}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r="Updated";e.id||(e.id=e.Email,r="Added");const s=e.Password;e.Password=null,ln.fillUpdatedInfo(e),await Ft(Ae(n,e.Email),e),an.log(e,"User",r+":"+JSON.stringify(e)),r=="Added"&&await os.createUser(e.Email,s)}async getById(e){if(!e)return;const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data()}async list(){const e=_e(ge,this.collectionName);return(await Ct(e)).docs.map(s=>s.data())}}class Ow{constructor(){this.collectionName=De.USER_CUSTOMER_MAPPING}async list(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));return r.exists()?r.data().customers:[]}async addOrUpdate(e,n){const r=_e(ge,this.collectionName);return await Ft(Ae(r,e),{customers:n})}}class Pw{constructor(){this.collectionName=De.RATES}async addOrUpdate(e){let n=Yn.getTodayAsString();const r=_e(ge,this.collectionName);var s={rate:e.rate,date:n};ln.fillUpdatedInfo(s),await Ft(Ae(r,n),s),an.log(s,"Rate","Changed rate to "+s.rate)}async list(){const e=_e(ge,this.collectionName),n=Lt(e,ts("date","desc"),Ti(10));return(await Ct(n)).docs.map(i=>i.data())}async getTodaysRate(){let e=Yn.getTodayAsString();const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data().rate}}class kw{constructor(){this.collectionName=De.CCUSTOMERS}async list(e,n=!1,r=!1){const s=_e(ge,this.collectionName);var i=null;n&&(i=Ii("status","==","Active"));const o=Lt(s,i);var c=(await Ct(o)).docs.map(h=>h.data());if(!r){console.log("Called");const h=await Vw.list(os.getCurrentUser().email);c=_.filter(c,function(m){return h.includes(m.id)})}if(e){const h=e.toLowerCase();c=_.filter(c,function(m){return m.Name.toLowerCase().includes(h)||m.Contact&&m.Contact.toString().toLowerCase().includes(h)})}return c=_.sortBy(c,function(h){return h.Name}),c}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r="Updated";e.id||(e.id=Ae(n).id,r="Added"),ln.fillUpdatedInfo(e),await Ft(Ae(n,e.id),e),an.log(e,"Customer",r+":"+JSON.stringify(e))}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data()}async runDebitCreditTransaction(e,n,r){const s=Ae(_e(ge,this.collectionName),e);try{await v_(ge,async i=>{const o=await i.get(s);if(!o.exists())throw"Document does not exist!";const a=r+"Debit",c=r+"Credit",h=o.data();n<0?h[a]?h[a]+=n*-1:h[a]=n*-1:h[c]?h[c]+=n:h[c]=n,i.update(s,h)}),console.log("Transaction successfully committed!")}catch(i){console.log("Transaction failed: ",i)}}}class Dw{constructor(){this.collectionName=De.PRODUCTS}async list(e){const n=_e(ge,this.collectionName),r=Lt(n,ts("Name"));var i=(await Ct(r)).docs.map(o=>o.data());if(e){const o=e.toLowerCase();i=_.filter(i,function(a){return a.Name.toLowerCase().includes(o)})}return i}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r="Updated";e.id||(e.id=Ae(n).id,r="Added"),ln.fillUpdatedInfo(e),await Ft(Ae(n,e.id),e),an.log(e,"Product",r+":"+JSON.stringify(e))}}class xw{constructor(){this.collectionName=De.CASH_PAYMENTS}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e.receiptNumber));if(r.exists())throw"Cash payment cannot be updated";ln.fillUpdatedInfo(e),await Ft(Ae(n,e.receiptNumber),e),await Xd.runDebitCreditTransaction(e.customerId,e.amount,"Cash"),an.log(e,"CashPayment","Added :"+e.receiptNumber)}async list(e,n){const r=_e(ge,this.collectionName),s=Lt(r,ts("paymentDate","desc"),Ti(10));return(await Ct(s)).docs.map(a=>a.data())}async listByCustomer(e){if(!e)return[];const n=_e(ge,this.collectionName),r=Lt(n,Ii("customerId","==",e));return(await Ct(r)).docs.map(o=>o.data())}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data()}}class Nw{constructor(){this.collectionName=De.GOLD_PAYMENTS}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e.receiptNumber));if(r.exists())throw"Gold Payment cannot be updated";ln.fillUpdatedInfo(e),await Ft(Ae(n,e.receiptNumber),e),await Xd.runDebitCreditTransaction(e.customerId,e.weight*(e.purity/1e3),"Gold"),an.log(e,"GoldPayment","Added :"+e.receiptNumber)}async list(e,n){const r=_e(ge,this.collectionName),s=Lt(r,ts("paymentDate","desc"),Ti(10));return(await Ct(s)).docs.map(a=>a.data())}async listByCustomer(e){if(!e)return[];const n=_e(ge,this.collectionName),r=Lt(n,Ii("customerId","==",e));return(await Ct(r)).docs.map(o=>o.data())}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Ae(n,e));if(r.exists())return r.data()}}class Lw{async tryLogin(e,n){const r=vs();return await uv(r,e,n)}getCurrentUser(){return vs().currentUser}async createUser(e,n){return await cv(vs(),e,n)}async signOut(){this.getCurrentUser()&&await vs().signOut()}}class $w{constructor(){this.collectionName=De.AUDIT}async log(e,n,r){_e(ge,this.collectionName)}}class Mw{fillUpdatedInfo(e){const n=os.getCurrentUser();e.updatedByDisplayName=n.displayName??n.email,e.updatedBy=n.uid,e.updatedOn=Yn.getNowAsMilliSeconds()}}const Ob=new Aw,Pb=new Rw,kb=new Pw,Xd=new kw,Db=new Dw,xb=new Cw,Uw=new xw,Fw=new Nw,os=new Lw,an=new $w,ln=new Mw,Vw=new Ow,jw=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},Bw={data:function(){return{hasAdminPrivillage:!1}},mounted:function(){this.hasAdminPrivillage=os.getCurrentUser().email==this.$adminMailId}},qw={class:"navbar navbar-expand-lg navbar-light bg-light"},Hw={class:"container-fluid"},zw=de("button",{class:"navbar-toggler",type:"button","data-bs-toggle":"collapse","data-bs-target":"#navbarTogglerDemo02","aria-controls":"navbarTogglerDemo02","aria-expanded":"false","aria-label":"Toggle navigation"},[de("span",{class:"navbar-toggler-icon"})],-1),Ww={class:"collapse navbar-collapse",id:"navbarTogglerDemo02"},Kw={class:"navbar-nav me-auto mb-2 mb-lg-0"},Gw={class:"nav-item"},Yw={class:"nav-item"},Jw={class:"nav-item"},Qw={class:"nav-item"},Xw={class:"nav-item"},Zw={key:0,class:"nav-item"},eb={class:"nav-item"},tb={class:"nav-item"},nb={class:"navbar-nav me-auto mb-2 mb-lg-0"},rb={class:"nav-item dropdown"},sb=de("a",{class:"nav-link dropdown-toggle",href:"#",id:"navbarDropdown",role:"button","data-bs-toggle":"dropdown","aria-expanded":"false"},"Settings ",-1),ib={class:"dropdown-menu","aria-labelledby":"navbarDropdown"},ob={key:0},ab=de("li",null,[de("hr",{class:"dropdown-divider"})],-1),lb={class:"d-flex"},cb={class:"navbar-nav me-auto mb-2 mb-lg-0"},ub={class:"nav-item dropdown btn btn-outline-success"},db=de("a",{class:"nav-link dropdown-toggle",href:"#",id:"navbarDropdown",role:"button","data-bs-toggle":"dropdown","aria-expanded":"false"}," New ",-1),hb={class:"dropdown-menu","aria-labelledby":"navbarDropdown"};function fb(t,e,n,r,s,i){const o=Tf("RouterLink");return _n(),ki(ot,null,[de("nav",qw,[de("div",Hw,[we(o,{class:"navbar-brand",to:"/"},{default:Ke(()=>[de("h3",null,pc(this.$appShortName),1)]),_:1}),zw,de("div",Ww,[de("ul",Kw,[de("li",Gw,[we(o,{to:"/invoices",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Invoices")]),_:1})]),de("li",Yw,[we(o,{to:"/customers",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Customers")]),_:1})]),de("li",Jw,[we(o,{to:"/products",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Products")]),_:1})]),de("li",Qw,[we(o,{to:"/payments",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Cash Transactions")]),_:1})]),de("li",Xw,[we(o,{to:"/goldtransactions",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Gold Transactions")]),_:1})]),t.hasAdminPrivillage?(_n(),ki("li",Zw,[we(o,{to:"/users",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Users")]),_:1})])):Wa("",!0),de("li",eb,[we(o,{to:"/rates",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Metal Rate")]),_:1})]),de("li",tb,[de("ul",nb,[de("li",rb,[sb,de("ul",ib,[t.hasAdminPrivillage?(_n(),ki("li",ob,[we(o,{to:"/settings/application",class:"dropdown-item","aria-current":"page"},{default:Ke(()=>[tt(" General Settings")]),_:1})])):Wa("",!0),ab,de("li",null,[we(o,{to:"/logout",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Logout ")]),_:1})])])])])])]),de("form",lb,[de("ul",cb,[de("li",ub,[db,de("ul",hb,[de("li",null,[we(o,{to:"/invoice",class:"dropdown-item"},{default:Ke(()=>[tt(" Invoice")]),_:1})]),de("li",null,[we(o,{to:"/payment",class:"dropdown-item"},{default:Ke(()=>[tt(" Cash Payment")]),_:1})]),de("li",null,[we(o,{to:"/goldtransaction",class:"dropdown-item"},{default:Ke(()=>[tt(" Gold Payment")]),_:1})])])])])])])])]),Cf(t.$slots,"default")],64)}const pb=jw(Bw,[["render",fb]]),mb={class:"pricing-header p-3 pb-md-4 mx-auto text-center"},gb={class:"display-4 fw-normal"},yb=de("p",{class:"fs-5 text-body-secondary"},null,-1),_b={mounted:function(){}},vb=Object.assign(_b,{__name:"HomeView",setup(t){return(e,n)=>(_n(),ci(pb,null,{default:Ke(()=>[de("div",mb,[de("h2",gb,"Welcome to "+pc(e.$appname),1),yb])]),_:1}))}}),Zd=Rm({history:zp("/goldsmithjk/"),routes:[{path:"/",name:"home",component:vb},{path:"/invoice",name:"invoice",component:()=>Me(()=>import("./Invoice-d860b41b.js"),["assets/Invoice-d860b41b.js","assets/InvoiceItemTable-f1e0337f.js","assets/CAlert-d4ea3aa9.js","assets/CustomerPicker-0a0eecd3.js"])},{path:"/invoices/:invoicenumber",name:"invoicereport",component:()=>Me(()=>import("./InvoiceReport-483b1d33.js"),["assets/InvoiceReport-483b1d33.js","assets/InvoiceItemTable-f1e0337f.js","assets/CAlert-d4ea3aa9.js"])},{path:"/login",name:"login",component:()=>Me(()=>import("./Login-71a52774.js"),["assets/Login-71a52774.js","assets/CAlert-d4ea3aa9.js"])},{path:"/logout",name:"logout",component:()=>Me(()=>import("./Logout-f012bac4.js"),["assets/Logout-f012bac4.js","assets/CAlert-d4ea3aa9.js"])},{path:"/customers",name:"customers",component:()=>Me(()=>import("./Customers-9c103539.js"),["assets/Customers-9c103539.js","assets/DynamicTable-179fc103.js","assets/DynamicDialog-a38b8e5f.js","assets/CAlert-d4ea3aa9.js"])},{path:"/customers/:customerid",name:"customerdetails",component:()=>Me(()=>import("./CustomerDetails-47b77df7.js"),["assets/CustomerDetails-47b77df7.js","assets/CAlert-d4ea3aa9.js","assets/TwoColumnTable-4d28e397.js","assets/DynamicTable-179fc103.js"])},{path:"/users",name:"users",component:()=>Me(()=>import("./Users-d8c21c41.js"),["assets/Users-d8c21c41.js","assets/DynamicTable-179fc103.js","assets/DynamicDialog-a38b8e5f.js","assets/CAlert-d4ea3aa9.js"])},{path:"/invoices",name:"invoices",component:()=>Me(()=>import("./Invoices-c5bd8879.js"),["assets/Invoices-c5bd8879.js","assets/CAlert-d4ea3aa9.js","assets/DynamicTable-179fc103.js"])},{path:"/rates",name:"rates",component:()=>Me(()=>import("./Rates-45d6df9e.js"),["assets/Rates-45d6df9e.js","assets/DynamicTable-179fc103.js","assets/CAlert-d4ea3aa9.js"])},{path:"/products",name:"products",component:()=>Me(()=>import("./Products-ba221a84.js"),["assets/Products-ba221a84.js","assets/DynamicTable-179fc103.js","assets/DynamicDialog-a38b8e5f.js","assets/CAlert-d4ea3aa9.js"])},{path:"/settings/application",name:"applicationsettings",component:()=>Me(()=>import("./Applicationsettings-a23eab15.js"),["assets/Applicationsettings-a23eab15.js","assets/CAlert-d4ea3aa9.js","assets/TwoColumnTable-4d28e397.js"])},{path:"/settings/product",name:"productSettings",component:()=>Me(()=>import("./ProductSettings-8b6c60c5.js"),["assets/ProductSettings-8b6c60c5.js","assets/DynamicTable-179fc103.js","assets/DynamicDialog-a38b8e5f.js","assets/CAlert-d4ea3aa9.js"])},{path:"/settings/customer",name:"customerSettings",component:()=>Me(()=>import("./CustomerSettings-e500138d.js"),["assets/CustomerSettings-e500138d.js","assets/DynamicTable-179fc103.js","assets/DynamicDialog-a38b8e5f.js","assets/CAlert-d4ea3aa9.js"])},{path:"/payments",name:"payments",component:()=>Me(()=>import("./Payments-011b1e39.js"),["assets/Payments-011b1e39.js","assets/DynamicTable-179fc103.js","assets/CAlert-d4ea3aa9.js"])},{path:"/payment",name:"payment",component:()=>Me(()=>import("./Payment-db020064.js"),["assets/Payment-db020064.js","assets/CustomerPicker-0a0eecd3.js","assets/CAlert-d4ea3aa9.js"])},{path:"/payments/:receiptNumber",name:"paymentReport",component:()=>Me(()=>import("./PaymentReport-b5358cef.js"),["assets/PaymentReport-b5358cef.js","assets/CAlert-d4ea3aa9.js"])},{path:"/goldtransactions",name:"goldtransactions",component:()=>Me(()=>import("./GoldTransactions-268c2bea.js"),["assets/GoldTransactions-268c2bea.js","assets/DynamicTable-179fc103.js","assets/CAlert-d4ea3aa9.js"])},{path:"/goldtransaction",name:"goldtransaction",component:()=>Me(()=>import("./GoldTransaction-88b47e3a.js"),["assets/GoldTransaction-88b47e3a.js","assets/CustomerPicker-0a0eecd3.js","assets/CAlert-d4ea3aa9.js"])}]}),Vt=Ap(Pm);Vt.use(Zd);Vt.mount("#app");Vt.config.globalProperties.$currentuser={};Vt.config.globalProperties.$appname="Emirates Pearl Jewellery";Vt.config.globalProperties.$appShortName="Emirates Pearl";Vt.config.globalProperties.$basedomainname="/goldsmithjk/";Vt.config.globalProperties.$statusLabelMapper={enabled:"Active",disabled:"Inactive"};Vt.config.globalProperties.$alertShowDuration=3e3;Vt.config.globalProperties.$adminMailId="admin@goldsmith.com";Zd.beforeEach((t,e,n)=>{if(t.path.startsWith("/payments/")||t.path.startsWith("/invoices/")||t.path.startsWith("/login")||t.path.startsWith("/goldtransaction/")){n();return}os.getCurrentUser()?n():n({path:"/login",query:{nextUrl:t.path}})});export{Yl as A,Io as B,Yn as C,ys as D,Vw as E,ot as F,Sb as G,Pb as H,Rb as I,Ib as J,Hi as S,jw as _,Wa as a,de as b,ki as c,Tf as d,Cb as e,we as f,Tb as g,ci as h,Ke as i,pb as j,kb as k,Ob as l,tt as m,Xd as n,_n as o,Db as p,Cf as q,Eb as r,xb as s,pc as t,yn as u,Ab as v,bb as w,os as x,Uw as y,Fw as z};
